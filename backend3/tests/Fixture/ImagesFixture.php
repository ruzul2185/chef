...
class ImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'review_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'review_id' => 1,
                'type' => 1,
                'created' => '2024-06-18 14:46:51',
                'modified' => '2024-06-18 14:46:51',
            ],
        ];
        parent::init();
    }
