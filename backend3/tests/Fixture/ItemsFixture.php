...
class ItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'color' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'size' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created_at' => 1718135633,
                'updated_at' => 1718135633,
            ],
        ];
        parent::init();
    }
